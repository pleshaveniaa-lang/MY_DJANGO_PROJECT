    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ForeignKey(blank=True, help_text='Выберите жанр для книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.genre', verbose_name='Жанр книги')),
                ('language', models.ForeignKey(blank=True, help_text='Выберите язык для книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.language', verbose_name='Язык книги')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inv_nom', models.CharField(blank=True, help_text='Введите инвентарный номер книги', max_length=20, null=True, verbose_name='Инвентарный номер книги')),
                ...
                ('status', models.ForeignKey(blank=True, help_text='Изменить состояние экземпляра', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Статус экземпляра книги')),
            ],
        ),
    ]
